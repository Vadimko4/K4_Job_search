...
from src.file_handler import DEFAULT_VACANCY_JSON_FILE_NAME, PATH_TO_DATA_DIR, JSONSaver
    ...
    while not quit_flag:
        ...
        try:  # файл с таким именем уже существует
            ...
            print("\nПрограмма: файл с таким именем уже существует\n"
                  "0 - вернуться в меню действий с файлом\n"
                  "1 - ввести другое имя файла\n"
                  "2 - перезаписать данные поверх\n"
